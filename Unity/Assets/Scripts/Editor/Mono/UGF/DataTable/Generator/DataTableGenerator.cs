...
namespace UGF.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        ...
        private const string CSharpCodePath = "Assets/Scripts/Game/Generate/DataTable";
        ...
        public static void GenerateCodeFile(DataTableProcessor dataTableProcessor, string dataTableName)
        {
            ...
            if (!CheckIsChanged(dataTableProcessor, dataTableName))
            {
        ...
        {
            string oldCsharpCodePath = Path.Combine(CSharpCodePath, "DR" + dataTableName + ".cs");
