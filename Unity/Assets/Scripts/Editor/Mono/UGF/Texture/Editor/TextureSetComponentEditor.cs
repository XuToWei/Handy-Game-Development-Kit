...
namespace UGF.Editor
{
    ...
    public class TextureComponentEditor : UnityEditor.Editor
    {
        ...
        private TextureComponent Target => target as TextureComponent;
        private List<TextureComponent.LoadTextureObject> m_List;
        private List<TextureComponent.LoadTextureObject> m_TempList;
        ...
        private void OnEnable()
        {
            ...
            m_TempList = new List<TextureComponent.LoadTextureObject>();
            m_List = new List<TextureComponent.LoadTextureObject>();
        }
